const MovieModule = (
    () => {
        ...
        const itemName = "movies"; // greit å definere en variabel som inneholder navnet på localStorage item, da er det lettere å unngå å skrive feil, samt at hvis man trenger å endre på navnet gjør man det bare her.
        ...
        */        
        ...
        const getByCategory = (category) => {
            ...
            const filteredArray = fullArray.filter( movie => movie.category === category );
        ...
        const deleteMovie = (id) => { // det finnes flere måter å slette noe på fra en array. Måten nedenfor gjør at man lar være å inkludere filmen som har id'en som er angitt.
            const fullArray = getAll();
            const newArrayWithoutDeleteMovie = fullArray.filter( movie => movie.id !== id );
